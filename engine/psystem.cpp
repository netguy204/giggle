...
Program* p_es_program_loader() {
  Program *program = renderer_link_shader("resources/p_es.vert",
                                          "resources/p_es.frag",
...
Program* pc_es2_program_loader() {
  Program *program = renderer_link_shader("resources/pc_es2.vert",
                                          "resources/pc_es2.frag",
                                          GLPARAM_VERTEX, "vertex",
...
Program* p_es2_program_loader() {
  Program *program = renderer_link_shader("resources/p_es2.vert",
                                          "resources/p_es2.frag",
                                          GLPARAM_VERTEX, "vertex",
                                          GLPARAM_TEXCOORD0, "tex_coord0",
                                          GLPARAM_DONE);
  program_bind_uniforms(program,
