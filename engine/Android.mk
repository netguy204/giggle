...
LOCAL_CFLAGS	:= -Werror -Ijni/vender/libogg-1.3.0/include -Ijni/vender/tremor -Ijni/vender/lua-5.2.1/src -Ijni/$(B2D_BASE) -DSFMT_MEXP=607 $(FORCE_ARM) -include "android_fopen.h" -include "sys/endian.h"
LOCAL_CFLAGS+= -D_ARM_ASSEM_ -Wa,-mimplicit-it=thumb
...
LOCAL_LDLIBS    := -llog -lGLESv2 -lEGL -landroid -lGLESv1_CM
LOCAL_ARM_NEON	:= true
